...
const EditJobPage = ({ updateJobSubmitForm }) => {
	const { id } = useParams();
	...
	const submitForm = (e) => {
		...
		updateJobSubmitForm(newJob);
		toast.success("Job updated successfully");
		return navigate(`/jobs/${jobs.id}`);
	};
			...
			<div className="container m-auto max-w-2xl py-24">
				<div className="bg-white px-6 py-8 mb-4 shadow-md rounded-md border m-4 md:m-0">
					<form onSubmit={submitForm}>
						...
						<div>
							<button
								className="bg-amber-500 hover:bg-neutral-400 text-white font-bold py-2 px-4 rounded-full w-full focus:outline-none focus:shadow-outline"
								type="submit"
							>
								Update Job
							</button>
